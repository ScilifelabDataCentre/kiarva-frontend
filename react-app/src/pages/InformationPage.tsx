...
export default function InformationPage(): ReactElement {
  ...
  <li className="mb-1">dbGaP_PopFreq: Aggregated frequency data on over 1 million individuals.</li>
  <li className="mb-1">1000Genomes: Includes data for 2,504 individuals from a total of 26 populations.</li>
  <li className="mb-1">GnomAD: A variant collection incorporating 602M SNVs and 105M indels identified through whole-genome sequencing of 71,702 samples that were subsequently mapped to the GRCh38 reference assembly.</li>
  <li className="mb-1">ExAC: The Exome Aggregation Consortium (ExAC) dataset accumulated SNP variation data on 60,706 unrelated individuals that were sequenced during the analysis of several disease specific and population related projects.</li>
  <li className="mb-1">TOPMED: The TOPMED dataset utilizes data from 158,000 individuals of mainly European, African, Hispanic/Latino or East Asian ancestry.</li>
  <li className="mb-1">TOMMO: An allele frequency panel produced from the genomic sequence analysis of 8380 Japanese individuals.</li>
  <li>KOREAN Reference Genome Database:  containing SNP variation data on 1465 Korean individuals</li>
</ol>
        <p className="text-justify">
