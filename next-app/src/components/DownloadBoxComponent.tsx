...
const DownloadBoxComponent: React.FC<DownloadBoxComponentProps> = ({
  ...
  return (
    <fieldset className="form-control basis-1/6 rounded-2xl mt-4 lg:mt-6 bg-white shadow-lg hover:shadow-2xl">
      ...
      <div className="grow mx-8 border-t border-secondary/30"></div>
