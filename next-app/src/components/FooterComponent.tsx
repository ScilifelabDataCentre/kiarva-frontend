          ...
          l.external ? (
            <li key={l.href}>
              <a
                ...
                className="text-sm text-primary-foreground hover:text-primary-foreground hover:underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-foreground/50 rounded-sm"
              >
                {l.label}
